...
<div class="widget-header"> <i class="icon-list-alt"></i>
              <h2 align="center"> Karokanca Cofee</h2>
			  <p align="center">Laporan Hasil Clustering</p>
			  <p align="center">KLASIFIKASI PRODUK MENGGUNAKAN METODE CLUSTERING K-MEANS DALAM PENENTUAN STOK PRODUK PADA Karokance Cofee </p>
			  <hr/>
            </div>
            <!-- /widget-header -->
